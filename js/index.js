...
function upTime(countTo) {
    ...
    if (difference < 0) {
        ...
        document.getElementById('days').firstChild.nodeValue = 0;
        ...
        document.getElementById('days-2').firstChild.nodeValue = 0;
        document.getElementById('hours-2').firstChild.nodeValue = 0;
        document.getElementById('minutes-2').firstChild.nodeValue = 0;
        document.getElementById('seconds-2').firstChild.nodeValue = 0;

        document.getElementById('days-3').firstChild.nodeValue = 0;
        document.getElementById('hours-3').firstChild.nodeValue = 0;
        document.getElementById('minutes-3').firstChild.nodeValue = 0;
        document.getElementById('seconds-3').firstChild.nodeValue = 0;
    }
